# Run unit test
Copy-Item $env:APPVEYOR_BUILD_FOLDER\Extensions\bin\Release\PixelsForGlory.Extensions.* -Destination $env:APPVEYOR_BUILD_FOLDER\ExtensionsTest\bin\Release\ -Force
